...
- [pict-template](https://fable-retold.github.io/pict-template/) - Template expression base class
- [pict-template-audit](https://github.com/fable-retold/pict-template-audit) - Template performance auditing
- [precedent](https://fable-retold.github.io/precedent/) - Pattern trie engine used for template matching
